...
- [ ] 1부터 9까지 서로 다른 수로 이루어진 3자리 수 랜덤숫자 생성하기
- [ ] 숫자 생성에 대한 테스트 케이스 작성
- [ ] 사용자에게 3자리 숫자 입력받기
- [ ] 사용자가 값을 잘못 입력할 경우 예외를 발생
- [ ] 예외 사항에 대한 테스트 케이스 작성
- [ ] 사용자가 제시한 숫자와 랜덤숫자 비교하여 결과 표시하기
- [ ] 숫자 비교에 대한 테스트 케이스 작성
- [ ] 사용자가 모든 숫자를 맞출 때까지 반복하여 입력받기
- [ ] 반복 입력에 대한 테스트 케이스 작성
- [ ] 사용자가 숫자를 맞춘 후 재시작 여부 물어보기
